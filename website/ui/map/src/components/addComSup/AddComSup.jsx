...
import "./style.css";
class AddComSup extends React.Component{
    constructor(props){
         super(props);
        this.state = {
            type:'',
                 ...
                 <div className = 'adding-header'>
                    ...
                    <div className = 'first-row-container'>
                       <div className = 'house-type-container'>
                        <div className = 'house-type-text'>Organizers:</div>
                    ...
                    <div className = 'first-row-container'>
                       ...
                       <div className = 'house-type-text'>Offering:</div>
                        <textarea className = 'description' value = {this.state.offering} onChange = {(e) => this.handleOnChange(e,4)} rows = '4' cols = '43'></textarea>
                        </div>
                       </div>
                    </div>
