...
class InteractiveMap extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            mapSideIcons: [houses,jobs,schools,stores, comsups,favs],
            ...
            sideIcons: ['homes','jobs','schools','stores','community supports', 'favorites'],
            hasAccount:false,
            currentMenuHover:-1,
            changeMenu:true,
            canadaOrmap:true,
                  ...
                  <div className = "top-menu-options">
                    ...
                    {this.state.selectedIndex!=-1&& !this.state.menuColapsed? 
                            <div className = "side-menu-container-open">
                                ...
                                <div className = {this.state.selectedTopIndex!= 4 ? 'all-menu-contents':'call-menu-contents' }>
